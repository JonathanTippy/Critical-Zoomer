...
async fn internal_behavior<A: SteadyActor, T:Clone + From<f32> + From<f32> + Clone + From<IntExp> + Sub<Output=T> + Add<Output=T> + Mul<Output=T> + PartialOrd + crate::actor::screen_worker::workshift::Finite + crate::actor::screen_worker::workshift::Gt + crate::actor::screen_worker::workshift::Abs + From<f32> + Into<f64> + Copy>(
    mut actor: A,
    from_sampler: SteadyRx<(ObjectivePosAndZoom, (u32, u32))>,
...
use std::ops::*;
fn get_points<T: From<f32> + Clone + From<IntExp> + Sub<Output=T> + Add<Output=T> + Mul<Output=T> + PartialOrd + crate::actor::screen_worker::workshift::Finite + crate::actor::screen_worker::workshift::Gt + crate::actor::screen_worker::workshift::Abs + From<f32> + Into<f64> + Copy>
...
fn handle_sampler_stuff<T: Clone + From<f32> + From<f32> + Clone + From<IntExp> + Sub<Output=T> + Add<Output=T> + Mul<Output=T> + PartialOrd + crate::actor::screen_worker::workshift::Finite + crate::actor::screen_worker::workshift::Gt + crate::actor::screen_worker::workshift::Abs + From<f32> + Into<f64> + Copy>(state: &mut WorkControllerState, stuff: (ObjectivePosAndZoom, (u32, u32))) -> Option<WorkContext<T>> {
