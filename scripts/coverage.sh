...
# Writes summary to docs/assistant/Trash/coverage-baseline.txt and HTML under target/llvm-cov/html
set -euo pipefail
...
SUMMARY="${ROOT}/docs/assistant/Trash/coverage-baseline.txt"
