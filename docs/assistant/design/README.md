...
- `naive-gpu-design.md` — Naive GPU port design lock (2026-08-08): wgpu, F32 + optional F64, control-plane queues / parallel bouts, FLOP-ratio IPS bar. **Read before implementing NaiveGpu.**
