...
- `shadergroup-virtues.md` — single shade path; colorer honest-rewrite parity bar;
  future OG↔GPU **color gear** switch (2026-08-11 interview).
...
- `../tracey.md` — install (prebuilt, not `cargo install` on 1.97), CLI
  (`query validate`), config paths. Validate-clean ≠ coverage-complete.
