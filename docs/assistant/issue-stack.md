...
- **GPU port of the golden design** (`docs/assistant/design/design-target.md`, `docs/assistant/design/naive-gpu-design.md`): views not tiles, full remap of old work, v0.0.9 semantics on GPU. **Design locked 2026-08-08** (wgpu; F32 + optional F64; serial authority / parallel `BoutCap` waves; queues as index control plane; IPS ≈ measured FLOP ratio ±20%). Implementation not started; must still follow `docs/assistant/design/workgroup-virtues.md`.
