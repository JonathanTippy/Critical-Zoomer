...
| 17 | Mag-43 “flat grey” + collector `to_f64(c)` | Screenshots are **four quadrants**, one lighter. Admit of i64 is correct. Suspects: CopyIntExp ops or accidental f64 in the worker. | **~44%** |
