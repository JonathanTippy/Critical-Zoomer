...
**Acceptance criteria.**
- [x] Bias inside → bias; bias below → lower; bias above → upper.
...
**Acceptance criteria.**
- [x] `NORES_ANSWER` packs/paints as Outside, not missing/Inside.
...
**Acceptance criteria.**
- [x] `DEFAULT_WINDOW_RES` is `(800, 480)`.
...
**Acceptance criteria.**
- [x] Classifier returns the four states from stencil geometry vs unit circle radius 2.
