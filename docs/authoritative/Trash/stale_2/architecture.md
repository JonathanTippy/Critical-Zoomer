...
flow per second (incomplete): [20, 100000] (20Hz refresh rate, max 100k Hz. 20Hz floor for when TPS falls below 20.)
...
flow per second (incomplete): [20, 100000] (20Hz refresh rate, max 100k Hz for token throughput.)
flow per second (complete): 0
